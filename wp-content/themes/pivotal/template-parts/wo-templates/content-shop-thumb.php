			...
			<div class="overley">
				<div class="winners-details">
					<div class="product-info">
						<ul>			
							<?php if ( function_exists( 'YITH_WCQV_Frontend' ) && $pivotal_option['wc_quickview_icon']  ): ?>
								<li>
									<a href="" class="yith-wcqv-button" data-product_id="<?php echo esc_attr( $product->get_id() );?>"><i class="fa fa-search"></i></a>
								</li>
							<?php endif; ?>
							<?php if ( class_exists( 'YITH_WCWL_Shortcode' ) && $pivotal_option['wc_wishlist_icon'] ): ?>
								<?php
									$args = array(
							...
							<?php endif; ?>
							<li><?php pivotal_wc_add_to_cart_icon();?></li>
						</ul>
					</div>
				</div>
			</div>
