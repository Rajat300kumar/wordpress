<?php
    if ( class_exists( 'WooCommerce' ) && is_shop() || class_exists( 'WooCommerce' ) && is_product_tag()  || class_exists( 'WooCommerce' ) && is_product_category()  ) {
        ...
        $footer_type = get_post_meta($pivotal_shop_id, 'footer_select', true);
        ...
        $footer_bg       = get_post_meta($pivotal_shop_id,'footer_bg', true);
        $footer_bg_img   = get_post_meta($pivotal_shop_id,'footer_bg_img', true);
        $copyright_bg    = get_post_meta($pivotal_shop_id,'copyright_bg', true);
        $copyright_trans = get_post_meta($pivotal_shop_id,'copyright_trans', true);
        $bg_pos          = get_post_meta($pivotal_shop_id,'footer_bg_position', true);
        $copy_space      = get_post_meta($pivotal_shop_id,'copyright_padding', true);
        ...
        $footer_select   = get_post_meta($pivotal_shop_id,'footer_select', true);
        $footer_select   = ($footer_select) ? $footer_select : '';
        $footer_style   = get_post_meta($pivotal_shop_id,'footer_style', true);
