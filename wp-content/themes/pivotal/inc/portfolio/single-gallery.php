...
<div class="container">
    ...
    <div class="container">
            ...
            <div class="col-lg-4">   
                ...
                <div class="ps-informations">
                    ...
                    <ul>
                      ...
                      <?php if($post_date){?>
                      <li><span><?php esc_html_e('Completed Date:','pivotal');?>  </span><?php   echo esc_html($post_date); ?></li>
                      <?php }?>
                      
                      <?php if($post_project_value){?>
                      <li><span><?php esc_html_e('Project Value:','pivotal');?>  </span><?php  echo esc_html($post_project_value); ?></li>
                      <?php }?>
                       <?php if($post_surface_area){?>
                      <li><span><?php esc_html_e('Mananer:','pivotal');?> </span><?php echo esc_html($post_surface_area); ?></li>
                      <?php }?>

                      <?php if($post_created){?>
                      <li><span><?php esc_html_e('Designer:','pivotal');?> </span><?php echo esc_html($post_created); ?></li>
                      <?php }?>
        ...
        <div class="ps-image-wrap clearfix">
            <h3 class="p-gallery-title"><?php esc_html_e('Project Gallery', 'pivotal') ?></h3>
