<div class="rs-blog home-blog-area blog_style2 <?php echo $css_class_custom; ?>">
	<div class="blog-carousel blog-slider owl-carousel owl-navigation-yes" data-carousel-options="<?php echo esc_attr( $owl_data );?>">
	 <?php 
		...
		?>	
		<div class="blog-style2 blog-item <?php echo $align; ?> <?php echo $news_style;?> <?php echo $no_thumb;?>">
