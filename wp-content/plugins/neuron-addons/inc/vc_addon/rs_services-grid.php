...
*/
    ...
    function vc_service_mapping() {
        ...
        $category_dropdown = array( __( 'All Services', 'neuron_addon' ) => '0' );	
        $args = array(
        ...
        vc_map( 
            array(
                'name' => __('Services Grid', 'neuron_addon'),
                'base' => 'vc_service',
                'description' => __('Service Box Information', 'neuron_addon'), 
                ...
                'params' => array(
                    ...
                    array(
                    	"type" => "dropdown",
                    	"heading" => __("Service Style", "medvill"),
                    	"param_name" => "service_style",
                    	"value" => array(		
                    		__("Style 1", "medvill") => "1",
                    		__("Style 2", "medvill") => "2",
                    		__("Style 3", "medvill") => "3",
                    		__("Style 4", "medvill") => "style4",
                    	),
                    	"description" => __("Select your Services style here", "medvill"),                    	
                    ),

                    array(
						"type" => "dropdown",
						"heading" => __("Show title", "medvill"),
						"param_name" => "title",
						"value" => array(							    						
							'Yes' => "Yes", 
							'No' => "No",
                    ...
                    array(
						"type" => "dropdown",
						"heading" => __("Show Category", "medvill"),
					...
					array(
						'type' => 'textfield',
						'holder' => 'h3',						
						'heading' => __( 'Services Per Page', 'neuron_addon' ),
						'param_name' => 'per_page',
						'value' => __( '', 'neuron_addon' ),
						'description' => __( 'How many project want to show per page', 'neuron_addon' ),
						'admin_label' => false,
						'weight' => 0,
						'value' => '9'
					...
					array(
						"type" => "dropdown",
						"heading" => __("How many Column ", "medvill"),
						"param_name" => "column",
						"value" => array(							    						
					...
					array(
						...
						"description" => __( "Choose color", "medvill" ),
						'admin_label' => false,
                        'weight' => 0,
                        'group' => 'Style',
					),		
					...
					array(
						"type" => "colorpicker",
						"class" => "",
						"heading" => __( "Title color", "medvill" ),
